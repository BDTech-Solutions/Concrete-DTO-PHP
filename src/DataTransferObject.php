...
use BdtechSolutions\ConcreteDto\Contracts\IsDTO;

abstract class DataTransferObject implements IsDTO
{
  ...
  /**
   * Convert a custom data type in a DTO
   * @param DTOTo|string $conversor
   * @return mixed
   */
   ...
   * @param array $fields The values to be merged or updated in the new instance
